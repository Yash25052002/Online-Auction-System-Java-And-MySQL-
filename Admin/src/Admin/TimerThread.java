	...
	public void run() {
		...
		try 
		{
			...
			while(i.hasNext())
			{
				item=i.next();
				Barray=item.b;
				File file=new File("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Admin2\\AdminImages\\"+String.valueOf(item.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Admin2\\AdminImages\\"+String.valueOf(item.ID)+".txt");
