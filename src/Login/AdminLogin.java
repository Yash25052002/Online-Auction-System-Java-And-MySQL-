...
public class AdminLogin extends JFrame{
	...
	public AdminLogin() throws UnknownHostException, IOException {
		...
		icon=new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\ProjectImages2\\src\\ProjectImages2\\index.png");
		...
		lblAdminPortal.setBounds(724, 140, 174, 26);
		...
		icon2=new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\ProjectImages2\\src\\ProjectImages2\\login.jpg");
		
		panel = new JPanel();
		panel.setForeground(new Color(154, 205, 50));
		panel.setBackground(new Color(0, 100, 127));
		panel.setBounds(480, 171, 594, 411);
		...
		label_1.setBounds(640, 83, 354, 60);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\ProjectImages2\\src\\ProjectImages2\\Login2.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\ProjectImages2\\src\\ProjectImages2\\User5.png"));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\ProjectImages2\\src\\ProjectImages2\\pwd3.png"));
