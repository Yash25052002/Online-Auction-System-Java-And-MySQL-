	...
	public void refresh() throws Exception
	{
		...
		if(status && !flag)
		{
			...
			while(it.hasNext())
			{
				sentitem=it.next();
				Barray=sentitem.b;
				File file=new File("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Customer\\CustomerImages\\"+String.valueOf(sentitem.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Customer\\CustomerImages\\"+String.valueOf(sentitem.ID)+".txt");
