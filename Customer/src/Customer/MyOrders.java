...
public class MyOrders extends JPanel {
	...
	public void refresh() throws Exception
	{
		...
		while(i.hasNext())
		{
			item=i.next();
			Barray=item.b;
			File file=new File("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Customer\\CustomerImages\\"+String.valueOf(item.ID)+".txt");
			fos=new FileOutputStream(file);
			fos.write(Barray);
			image=new ImageIcon("C:\\Users\\YASH kAILAS DHADGE\\eclipse-workspace\\Customer\\CustomerImages\\"+String.valueOf(item.ID)+".txt");
